...
base_manufacturera_2020_2 <- base_manufacturera_2020_1 %>% rename(actividad_económica = ciiu4, trabajadores_hombres = c4r4c10t , trabajadores_mujeres = c4r4c9t, gastostransp_productos = c3r45c3, gastostransporte_insumos = c3r42c3 ,imp_industriacomercio = c3r37c3 , imp_predial_vehiculo = c3r38c3, inversion_transporte = c7r8c2, produccion_bruta = prodbr2 , valor_agregado = valagri)
view(base_manufacturera_2020_2)
